...
class TestAIAnalyzer(unittest.TestCase):
    ...
    def test_get_gemini_summary_without_genai(self):
    ...
    def test_get_gemini_summary_empty_params(self):
    ...
    def test_get_gemini_summary_success(self, mock_genai):
    ...
    @patch("utils.ai_analyzer.genai")
    @patch("utils.ai_analyzer.GENAI_AVAILABLE", True)
    def test_get_gemini_summary_api_error(self, mock_genai):
    ...
    @patch("utils.ai_analyzer.genai")
    @patch("utils.ai_analyzer.GENAI_AVAILABLE", True)
    def test_get_gemini_summary_empty_response(self, mock_genai):
